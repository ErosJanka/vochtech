...
@section('title', 'Criar Bandeira')

@section('content')
<h1 class="text-2xl font-bold mb-4">Criar Bandeira</h1>

@include('partials._form_errors')

<form action="{{ route('brands.store') }}" method="POST" class="bg-white p-6 rounded shadow">
    @csrf
    <div class="mb-4">
